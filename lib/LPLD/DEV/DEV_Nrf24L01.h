...
#define NRF24L01_IRQ    (PTC0)

//选择NRF24L01 CE所对应的IO
#define NRF24L01_CE_PTX  (PTA)
#define NRF24L01_CE_IOX  (GPIO_Pin28)
#define NRF24L01_CE_H    LPLD_GPIO_Output_b(PTA,28,OUTPUT_H) 
#define NRF24L01_CE_L    LPLD_GPIO_Output_b(PTA,28,OUTPUT_L)  //这是CE

// NRF24L01相关参数定义
#define NRF24L01_PLOAD_LEN        (3) //数据载荷长度
